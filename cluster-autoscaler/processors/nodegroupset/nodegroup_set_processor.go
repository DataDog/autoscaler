...
type NodeGroupSetProcessor interface {
	...
	BalanceScaleUpBetweenGroups(autoscalingCtx *ca_context.AutoscalingContext, groups []cloudprovider.NodeGroup, newNodes int, reserver func(groupID string) bool) ([]ScaleUpInfo, errors.AutoscalerError)
	CleanUp()
}
...
func (n *NoOpNodeGroupSetProcessor) BalanceScaleUpBetweenGroups(autoscalingCtx *ca_context.AutoscalingContext, groups []cloudprovider.NodeGroup, newNodes int, reserver func(groupID string) bool) ([]ScaleUpInfo, errors.AutoscalerError) {
