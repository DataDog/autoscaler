...
` + mapping + `        };
        ...
        if (docId === null || operation === null) {
            window.location = 'https://pkg.go.dev/k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2';
            return;
        }
		...
		window.location = 'https://pkg.go.dev/k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/' + service + '#Client.' + operation;
		})();
    </script>
</html>`
