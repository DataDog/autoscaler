...
var migProfileTables = map[string][]migVariant{
	...
	// VERIFIED: NVIDIA H100 80GB HBM3 (AWS p5). Captured from a real p5.48xlarge node's
	// published ResourceSlices. 8 memory slices, 132 SMs, 80GB. Zero NVENC encoders on
	// this GPU (unlike RTX PRO 6000). Plain profiles only — the
	// driver also publishes a "+me" variant per slice-1 profile (e.g. "1g.10gb+me", which
	// additionally consumes the OFA engine); media/graphics variants are omitted here (a
	// claim for a plain profile does not need them).
	"H100": {{
		gpuMemoryMiB:          81152,
		...
		memorySlices:          8,
		whole:                 engineCounts{multiprocessors: 132, copyEngines: 8, decoders: 7, encoders: 0, jpegEngines: 7, ofaEngines: 1, memory: "81152Mi"},
		profiles: []migProfile{
			{name: "1g.10gb", profileID: 19, memorySlices: 1, placements: []int{0, 1, 2, 3, 4, 5, 6}, engines: engineCounts{multiprocessors: 16, copyEngines: 1, decoders: 1, encoders: 0, jpegEngines: 1, ofaEngines: 0, memory: "9984Mi"}},
			{name: "1g.20gb", profileID: 15, memorySlices: 2, placements: []int{0, 2, 4, 6}, engines: engineCounts{multiprocessors: 26, copyEngines: 1, decoders: 1, encoders: 0, jpegEngines: 1, ofaEngines: 0, memory: "20096Mi"}},
			{name: "2g.20gb", profileID: 14, memorySlices: 2, placements: []int{0, 2, 4}, engines: engineCounts{multiprocessors: 32, copyEngines: 2, decoders: 2, encoders: 0, jpegEngines: 2, ofaEngines: 0, memory: "20096Mi"}},
			{name: "3g.40gb", profileID: 9, memorySlices: 4, placements: []int{0, 4}, engines: engineCounts{multiprocessors: 60, copyEngines: 3, decoders: 3, encoders: 0, jpegEngines: 3, ofaEngines: 0, memory: "40448Mi"}},
			{name: "4g.40gb", profileID: 5, memorySlices: 4, placements: []int{0}, engines: engineCounts{multiprocessors: 64, copyEngines: 4, decoders: 4, encoders: 0, jpegEngines: 4, ofaEngines: 0, memory: "40448Mi"}},
			{name: "7g.80gb", profileID: 0, memorySlices: 8, placements: []int{0}, engines: engineCounts{multiprocessors: 132, copyEngines: 8, decoders: 7, encoders: 0, jpegEngines: 7, ofaEngines: 1, memory: "81152Mi"}},
		},
	}},
