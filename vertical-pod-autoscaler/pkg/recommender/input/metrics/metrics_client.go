...
type MetricsClient interface {
	...
	GetContainersMetrics(state *model.ClusterState) ([]*ContainerMetricsSnapshot, error)
}
...
func NewMetricsClient(source Source, namespace string, clientName string) MetricsClient {
